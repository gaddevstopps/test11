...
st.title("Ad-Spending Business Finder (Final - Option A)")
...
if business_type and city:
    ...
    if ll_value:
        ...
        for idx, biz in enumerate(unique_websites):
            ...
            ads_summary = ad_data.get("ads_summary", {})
            ads_count = ads_summary.get("ads_count", 0)
            ...
            if ads_count > 0:
                advertised.append({
                    ...
                    "domain": domain,
                    "ads_count": ads_count,
                    "last_ads_date": ads_summary.get("last_ads_date", "N/A")
                })
